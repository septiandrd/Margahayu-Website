...
<body>
    ...
    <div class="container set-pad">
        <div class="row text-center">
            <div class="col-lg-8 col-lg-offset-2 col-md-8 col-sm-8 col-md-offset-2 col-sm-offset-2">
                <h1 data-scroll-reveal="enter from the bottom after 0.2s" class="header-line">PROFIL SEKOLAH</h1>
                <p data-scroll-reveal="enter from the bottom after 0.3s">
                    SMA Negeri 1 Margahayu, merupakan salah satu Sekolah Menengah Atas Negeri yang berlokasi
                    di Kabupaten Bandung, Provinsi Jawa Barat, Indonesia. Sama dengan SMA pada umumnya di Indonesia,
                    masa pendidikan sekolah di SMAN 1 Margahayu ditempuh dalam waktu tiga tahun pelajaran, mulai dari
    ...
    <div id="footer">
        &copy 2014 yourdomain.com | All Rights Reserved | <a href="http://binarytheme.com" style="color: #fff"
                                                             target="_blank">Design by : binarytheme.com</a>
    </div>
    <!-- FOOTER SECTION END-->
